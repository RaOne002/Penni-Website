  ...
  return (
    <section className="px-8 py-16 bg-mywhite w-full max-w-[1500px] mx-auto max-md:px-6 max-md:pt-0 max-md:pb-10">
      <div className="flex gap-8 justify-center max-md:flex-col-reverse">
        {/* Left: Image/Media */}
        <div className="w-[35%] flex justify-center items-center bg-myneutral-400 max-md:w-[90%] max-md:justify-center mx-auto">
            ...
            <div className="flex flex-col gap-6">
              {faqs.map((faq, idx) => (
                <div key={idx} className="relative">
                  <div
                    className="bg-myviolet-50 rounded-full px-8 py-6 text-[1.5rem] font-normal flex items-center justify-between cursor-pointer transition-shadow shadow-sm hover:shadow-md max-md:px-6 max-md:py-4 max-md:text-sm"
                  ...
                  {openIdx === idx && (
                    <div className="bg-myviolet-50 rounded-2xl shadow-lg px-8 py-6 text-lg text-myneutral-800 mt-2 max-md:px-4 max-md:py-4 max-md:text-base">
                      {faq.answer}
                    </div>
                  )}
                </div>
