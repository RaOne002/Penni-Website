...
export default function FAQSection() {
  ...
  return (
    <section className="px-16 py-20 max-w-full bg-mywhite w-[1500px] max-md:px-5 max-md:mt-5">
      <div className="flex gap-5 max-md:flex-col">
        <div className="w-[43%] max-md:ml-0 max-md:w-full">
          <div className="flex shrink-0 mx-auto max-w-full bg-myneutral-400 h-[550px] w-[698px] max-md:mt-10" />
        </div>
        <div className="ml-5 w-[57%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col pt-15 self-stretch my-auto w-full text-3xl font-medium text-myneutral-800 max-md:mt-10 max-md:max-w-full">
            ...
            <div className="flex flex-col gap-6">
              {faqs.map((faq, idx) => (
                <div key={idx} className="relative">
                  <div
                    className="bg-myviolet-50 rounded-full px-8 py-6 text-[1.5rem] font-normal flex items-center justify-between cursor-pointer transition-shadow shadow-sm hover:shadow-md"
                  ...
                  {openIdx === idx && (
                    <div className="bg-violet-50 rounded-2xl shadow-lg px-8 py-6 text-lg text-myneutral-800 mt-2">
                      {faq.answer}
                    </div>
                  )}
                </div>
